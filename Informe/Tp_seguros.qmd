...
datos_simulados <- data.frame(
  ...
  prop2 = cuantia_total_simulada2,
  prop3 = cuantia_total_simulada3
)
...
datos_simulados |> 
  ...
  stat_function(fun = dnorm, args = list(mean = mean(cuantia_total_simulada),
...
datos_simulados |> 
  ...
  geom_histogram(aes(y = after_stat(density)), bins = 50) +
    stat_function(fun = dnorm, args = list(mean = mean(cuantia_total_simulada),
                                         sd = sd(cuantia_total_simulada)), 
                color = "springgreen3", size = 1) +
  stat_function(fun = dnp, args = list(mu = mean(cuantia_total_simulada),
